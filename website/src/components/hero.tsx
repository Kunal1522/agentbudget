...
import { GitHubStars, PyPIDownloads, NpmDownloads, GoClones, PythonLogo, GoLogo, TSLogo } from "@/components/github-stars";
...
const LangIcon = ({ lang }: { lang: Lang }) => {
  if (lang === "Python") return <PythonLogo />;
  if (lang === "Go") return <GoLogo />;
  return <TSLogo />;
};
